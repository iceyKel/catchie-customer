...
<div class="icon-bar">
 ...
 <a href="finish_order.php"  class="notification"><i class="fa fa-bell">
	...
	<div class = 'header'><img width = "50%" src="image/logo/logo.png">
		<!--<div class="bck_page">
      		<a style = 'color: #2c3e50;font-size: 100%;text-align: center;' href="slct_store.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
   		</div>-->
	</div>
