        ...
        if($status == 'Ongoing'){
          ...
          echo "<tr>
               ...
               echo "<tr>
                ...
                <td style = 'font-weight:bold;color:#00b894'>Received</td>
              ...
              }elseif ($status == "Not Yet Delivered") {
              echo "<tr>
                <td>".$product_name."</td>
                <td>".$qty."</td>
                <td>PHP ".$price."</td>

                <td style = 'font-weight:bold;color:#3498db'>".$status."</td>
         ...
         $sql_total = "SELECT sum(price) FROM tblorders WHERE crt_code ='$crt_code' AND status = 'Ongoing'";
